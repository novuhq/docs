...
<Note>
Replace the `<NOVU_API_KEY>` value with the authentic key from the API Key section of your [Novu Dashboard.](http://dashboard.novu.co/?utm_campaign=docs-guides-headless)
</Note>
<Note>
