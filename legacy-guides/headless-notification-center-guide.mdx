...
1. `applicationIdentifier`: You can find this from the `settings` menu in the [Novu web dashboard.](https://dashboard.novu.co/settings?utm_campaign=docs-guides-headless)
...
<Note>
Replace the `<NOVU_SECRET_KEY>` value with the authentic key from the API Key section of your [Novu Dashboard.](http://dashboard.novu.co/?utm_campaign=docs-guides-headless)
</Note>
<Note>
