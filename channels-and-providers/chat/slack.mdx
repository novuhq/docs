...
6. You can use the generated `Shareable URL` that is found under the Slack integration in the [Integration Store](https://web.novu.co/integrations). The `Shareable URL` should have the following format:
```bash
