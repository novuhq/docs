...
2. You now need to make a network request to the `Shareable URL` in order to perform authentication.
...
<Note>Don't forget to checkout our [dedicated guide](/guides/slack-guide) on integrating Novu in a Slack app for more.</Note>
### 2. Manually managed
