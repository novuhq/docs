...
<Frame caption="Go to the bottom of your dashboard to find your API key"><img src="/images/image-72.png" /> </Frame>
...
<Frame caption="Select API Token from the dropdown to see your API key"><img src="/images/image-73.png" /> </Frame>
...
<Frame caption="Go to Rental on the sidebar to find your sender ID"><img src="/images/image-74.png" /> </Frame>
...
<Frame caption="Fill in the make a new request form to create a sender ID"><img src="/images/image-75.png" /> </Frame>
