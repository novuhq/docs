---
title: 'API reference'
description: 'Learn about all the methods related to the Headless notification center'
---
...
Fetches the user preferences. Read more [here](https://docs.novu.co/platform/preferences)
...
Updates the user preferences. Read more [here](https://docs.novu.co/platform/preferences)
