---
title: 'Headless notification center'
...
To read more about HMAC Encryption, visit [here](https://docs.novu.co/notification-center/react/react-components#hmac-encryption)
