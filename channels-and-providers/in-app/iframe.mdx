...
The notification center component can be customized by passing a `theme` to the init script. More information on all possible theme properties can be found [here](https://docs.novu.co/notification-center/react/react-components#customizing-the-notification-center-theme).
...
The language of the UI can be customized by passing an `i18n` component to the init script. More information on all possible properties for it can be found [here](https://docs.novu.co/notification-center/react/react-components#customize-the-ui-language).
...
| theme | object | Provide a custom theme for the notification center to use |
| styles | object | Provide a custom styles for the notification center. Please note that the limitation is that you can't use the style function as a prop to override the component styles. |
