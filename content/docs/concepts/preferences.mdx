...
<img src="/images/preferences/inbox-workflow-preferences.png" alt="Inbox Workflow Preferences" className="rounded-lg border w-[400px]" />
...
<img src="/images/preferences/inbox-global-preferences.png" alt="Inbox Global Preferences" className="rounded-lg border w-[400px]" />
