...
import { LayoutGrid, MousePointerClick, Brain } from 'lucide-react';

Signals let you change conversation state without sending another chat message. [Replies](/connect/custom-code-agent/setup-your-agent/reply) go to the user; signals update metadata, fire workflows, or mark a thread resolved.
