...
import { Zap, Brain, Link, Wrench } from 'lucide-react';
...
For a full breakdown of each component, see [Concepts](/connect/managed-agent/concepts).
...
If you need full control over the agent logic, want to call your own APIs directly in handlers, or need complex multi-step business flows, use a [custom code agent](/connect/custom-code-agent/quickstart) instead.

## Next steps

<Cards>
  <Card icon={<Zap />} href="/connect/managed-agent/quickstart" title="Quickstart">
  ...
  <Card icon={<Wrench />} href="/connect/managed-agent/add-skills" title="Add skills">
