...
Read more on how to build a [custom code agent](/connect/custom-code-agent/setup-your-agent/overview).
...
Read more on how to build a [managed agent](/connect/managed-agent/overview).
...
<Cards>
  <Card icon={<Plus />} href="/connect/custom-code-agent/setup-your-agent/overview" title="Custom code agent">
    Build a custom code agent.
  </Card>
  <Card icon={<Brain />} href="/connect/managed-agent/overview" title="Managed agent">
