...
<Accordion>
  <AccordionItem title="How do I purchase the business or enterprise tier?">
    ...
    <Image
      ...
      caption="Upgrade subscription from billing settings"
    />
  </AccordionItem>

  <AccordionItem title="How to access past invoices?">
    ...
    <Image
      ...
      caption="Access past invoices using manage subscription option"
    />
  </AccordionItem>
</Accordion>