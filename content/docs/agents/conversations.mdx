...
pageTitle: 'Manage agent conversations'
...
| WhatsApp | Available | Text, markdown, interactive buttons, typing indicators. Inbound media is surfaced via attachments; outbound file attachments are not supported yet. |
