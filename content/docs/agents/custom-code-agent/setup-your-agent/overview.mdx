---
title: "Overview"
pageTitle: 'Set up your agent: overview'
description: 'What you configure when setting up a Novu agent: dashboard settings, bridge, providers, and handler code.'
icon: Compass
---

import { MousePointerClick, Cloud, Brain, Plus } from 'lucide-react';

You set up an agent in two places: the Novu dashboard (name, providers, bridge URL, status) and your bridge app (handlers, replies, and signals). The pages in this section cover both sides.
...
<Cards>
  ...
  <Card icon={<MousePointerClick />} href="/agents/conversation-observability" title="Conversation observability">
