...
Choose **Create new agent** and write a system prompt that tells the agent who it is and how it should respond.
...
You can also pick from the available templates to get started quickly.
...
<Cards>
  ...
  <Card icon={<MessagesSquare />} href="/agents/conversation-observability" title="Conversation observability">
