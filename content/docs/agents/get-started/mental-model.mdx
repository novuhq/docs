...
Custom code agent is an agent where you build the agent brain with your custom code using agent sdk, lanchain etc. Your agent brain receives the context object and processes it however you decide. Call an LLM, run business logic, route to a human, or combine all three.
