...
In case of Custom code agent, you can use your custom code using agent sdk, lanchain etc. Your server receives the context object and processes it however you decide. Call an LLM, run business logic, route to a human, or combine all three.
...
In case of Custom code agent, you control:
...
In case of Managed agent, platform like Claude controls:
