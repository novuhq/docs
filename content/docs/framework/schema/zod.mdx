...
Novu Framework allows you to use [Zod](https://zod.dev/) to define the [Control](/docs/framework/controls) and [Payload](/docs/concepts/payload) schemas for your workflows.
