...
Novu Framework allows you to use [Zod](https://zod.dev/) to define the [Control](/framework/controls) and [Payload](/platform/concepts/payload) schemas for your workflows.
