...
Novu Cloud workers will need to be able to communicate with your [Bridge Endpoint](/docs/concepts/endpoint). You will need to ensure that your firewall rules allow traffic from the internet.
