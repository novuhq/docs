---
pageTitle: "Syncing your local changes to the Novu Cloud Dashboard"
title: "Syncing"
---
...
- **GitHub Actions** - [Direct Integration](/docs/framework/deployment/actions)
- **GitLab CI** - Using our [CLI command](/docs/framework/deployment/cli)
- **Jenkins** - Using our [CLI command](/docs/framework/deployment/cli)
- **CircleCI** - Using our [CLI command](/docs/framework/deployment/cli)
- **Bitbucket Pipelines** - Using our [CLI command](/docs/framework/deployment/cli)
- **Azure DevOps** - Using our [CLI command](/docs/framework/deployment/cli)
- **Travis CI** - Using our [CLI command](/docs/framework/deployment/cli)
- **Other** - For any other CI/CD tool, you can use our [CLI command](/docs/framework/deployment/cli)
