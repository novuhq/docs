...
To read more about the full list of parameters, check out the [full SDK reference](/platform/framework/typescript/steps/overview).
...
Tags are used to categorize the workflows. They also allow you to filter and group notifications for your [Inbox](/platform/inbox/overview) tabs.
