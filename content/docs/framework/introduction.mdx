...
To read more about the full list of parameters, check out the [full SDK reference](/docs/framework/typescript/steps/overview).
...
<Callout type="info">
Read the section on [Controls](/docs/framework/controls) next to learn how to expose Novu's no-code editing capabilities to your peers.
</Callout>
...
Tags are used to categorize the workflows. They also allow you to filter and group notifications for your [Inbox](/docs/inbox/overview) tabs.
