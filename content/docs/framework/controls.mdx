...
For the full list of parameters, check out the [full SDK reference](/docs/framework/typescript/steps/email).
...
- **[JSON Schema](/docs/framework/schema/json-schema)** - The most popular schema language for defining JSON data structures.
...
<img src="/images/controls-autocomplete.gif" alt="Example for variables autocomplete in dashboard" />

### Variable Options
- **Subscriber Attributes**: Access all [subscriber attributes](/docs/concepts/subscribers#subscriber-attributes). Example: `{{subscriber.firstName}}`
