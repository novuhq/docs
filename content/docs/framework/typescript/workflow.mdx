...
- **Description**: The preferences for the workflow. Read more about [Workflow Channel Preferences](/docs/concepts/preferences#workflow-channel-preferences).
...
- **Description**: The preferences for each channel. Read more about [Workflow Channel Preferences](/docs/concepts/preferences).
- **Properties**:
...
### step
- **Type**: `object`
- **Description**: The object that contains all the step functions, read more at [Step Functions](/docs/framework/typescript/steps/overview).
