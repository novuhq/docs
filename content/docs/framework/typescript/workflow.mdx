...
- **Description**: The preferences for the workflow. Read more about [Workflow Channel Preferences](/concepts/preferences#workflow-channel-preferences).
...
- **Description**: The preferences for each channel. Read more about [Workflow Channel Preferences](/concepts/preferences).
- **Properties**:
...
### step
- **Type**: `object`
- **Description**: The object that contains all the step functions, read more at [Step Functions](/framework/typescript/steps/overview).
