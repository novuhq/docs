...
When defining a [workflow payload](/platform/concepts/payload) schema, our SDK will automatically infer it to a Typescript interface.
...
Similarly, when defining a [step](/platform/framework/typescript/steps/overview) schema, our SDK will automatically infer it to a Typescript interface.
