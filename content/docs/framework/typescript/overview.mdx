---
pageTitle: "Novu Framework TypeScript SDK"
title: "Overview"
...
When defining a [workflow payload](/docs/concepts/payload) schema, our SDK will automatically infer it to a Typescript interface.
...
Similarly, when defining a [step](/docs/framework/typescript/steps/overview) schema, our SDK will automatically infer it to a Typescript interface.
...
- [Client](/docs/sdks/framework/typescript/client)
- [Workflow](/docs/sdks/framework/typescript/workflow)
- [Steps](/docs/sdks/framework/typescript/steps)
