...
This is an optional configuration object that defines: [Controls Schema](/docs/framework/controls), [Provider Overrides](#provider-overrides), skip and other configurations.
