...
To send push notifications, you need to configure the appropriate push provider credentials. See our [Push Provider Documentation](/integrations/providers/push/overview) for detailed setup instructions.
