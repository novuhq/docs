...
- **Type**: `object`
- **Required**: No
- **Description**: Custom data to be sent with the notification. This data can be used to [customize the notification item rendered](/platform/inbox/react/components#custom-notification-item) in the `<Inbox />`.
