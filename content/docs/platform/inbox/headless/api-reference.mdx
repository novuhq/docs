...
<TypeTable
  type={{
    tags: {
      type: "string[]",
      description: "Workflow tags can be used to filter notifications, and organize them into different groups. Read more about how can you define workflow tags."
    }
  }}
/>
