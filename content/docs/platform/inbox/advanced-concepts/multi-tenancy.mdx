...
<Callout>Learn more about applying Context in workflows in [Contexts in Workflows](/platform/workflow/advanced-features/contexts/contexts-in-workflows.mdx) documentation.</Callout>
