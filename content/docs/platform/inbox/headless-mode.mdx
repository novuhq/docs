...
2. Edit in-app step content and make this workflow as critical
3. Create a subscriber in the dashboard with subscriberId `product-updates-subscriber`
...
7. [Permanently delete](/api-reference/messages/delete-a-message) or [archive](/platform/sdks/javascript#archive) the product update notification to hide the banner.
