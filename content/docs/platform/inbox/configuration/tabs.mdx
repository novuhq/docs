...
Tabs in the Inbox component are used to organize in-app notifications into separate sections, creating a cleaner, more organized experience for your subscribers. Each tab displays a subset of in-app notifications based on defined rules, making it easier to surface important notifications.
...
For example, assign a 'promotions' tag to marketing workflows or 'security' and 'alert' tags to security workflows to group their notifications under dedicated tabs. To show all notifications in a tab, pass an empty array to the tags property.
...
Data object can be included in every in-app notification in the in-app editor editor. his object holds custom key-value pairs, which you can use to filter notifications into specific tabs.
