...
Here's a list of available elements that can be styled using the elements object in your appearance configuration: - WHERE IS THE LIST MENTIONED HERE?
...
### Using CSS modules - HOW IS THIS DIFFERENT THAN TAILWIND CSS? SHOULD WE LIST GENERAL CSS BEFORE THE SPECIFIC TAILWIND CSS?

You can style the Inbox components using [CSS Modules](https://github.com/css-modules/css-modules).

First, define the styles in a `.module.css` file:
