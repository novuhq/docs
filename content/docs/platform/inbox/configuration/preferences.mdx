...
Global preferences apply across all workflows. For instance, a subscriber can disable email or SMS channels globally, ensuring they don’t receive notifications through that channel from any workflow.
