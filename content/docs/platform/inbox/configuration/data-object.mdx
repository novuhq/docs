...
## Using data object keys as filter for tabs

You can use data object keys as filter for tabs. Read more on this on [tabs documentation](/platform/inbox/configuration/tabs#filter-tabs-by-data-attributes).
