...
For situations where you don't need the default popover and bell trigger, you can use the `<Notifications />` or `<InboxContent />` components to display just the list of notifications. This is useful for embedding the notification list directly into a page or a custom popover component.
