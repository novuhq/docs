...
Novu provides render props that can be used to customize specific parts of the default notification item seen in the Inbox UI, such as the subject, body, avatar, default and custom actions, and the entire notification.
