...
<Callout type="info">
  The InboxContent component provides a flexible way to customize the inbox display while
  maintaining all the core notification functionality.
</Callout>
...
<Callout type="info">
  The example above demonstrates how to: - Handle notification clicks - Customize primary and
  secondary action behaviors - Provide custom rendering for notifications
</Callout>
