...
Preference Grouping allows you to organize extensive lists of workflows into well-organized, meaningful groups. This enhances efficiency and simplifies the management of subscriber preferences.
...
When the Inbox component is rendered within a shadow DOM, it automatically detects it and ensures style isolation at the shadow root level with no extra configuration required.
