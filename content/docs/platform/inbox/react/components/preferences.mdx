...
<Callout type="info">
  You can filter the preferences visible by the user by specifying the `preferenceFilter` on the `Inbox` component.
  Learn more about it [here](/docs/inbox/react/components/inbox#filter-visible-preferences).
</Callout>
