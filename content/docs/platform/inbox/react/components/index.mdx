...
<Cards>
  <Card title="Inbox" icon={<Layout />} href="/inbox/react/components/inbox">
    The Inbox wrapper, which is used to wrap the entire inbox UI and establish the session
  </Card>
  <Card title="Bell" icon={<Bell />} href="/inbox/react/components/bell">
    Used to display the bell icon and trigger the popover component when clicked
  </Card>
  <Card title="Notifications" icon={<Code />} href="/inbox/react/components/notifications">
    Displays the notifications list
  </Card>
  <Card title="Preferences" icon={<Sliders />} href="/inbox/react/components/preferences">
    Used to display the preferences modal
  </Card>
  <Card title="InboxContent" icon={<Layout />} href="/inbox/react/components/inbox-content">
    Usage with a custom popover
  </Card>
</Cards>

The internal UI and styles for those components can be modified using the [`appearance`](/docs/inbox/react/styling#appearance-prop) prop.

<img 
  src="/images/inbox/component_composition.png" 
