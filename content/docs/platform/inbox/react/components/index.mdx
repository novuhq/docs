...
<Cards>
  ...
  <Card title="Notifications" icon={<Code />} href="/platform/inbox/react/components/notifications">
  ...
  <Card title="InboxContent" icon={<Layout />} href="/platform/inbox/react/components/inbox-content">
