...
<Callout type="info">
  ...
  You can learn how to pass it with the Novu Framework in-app step output [here](/framework/typescript/steps/inApp).
</Callout>
...
<Callout type="info">
  ...
  The filtering works by matching workflow [tags](/workflow/overview#tags) with the specified filter `tags` value.
</Callout>
