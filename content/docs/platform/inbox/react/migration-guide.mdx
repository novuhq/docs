...
<Callout type="info">
  [@novu/react](/inbox/react/get-started) Inbox react component and
  [@novu/js](/inbox/headless/get-started) headless package is compatible with
  [@novu/framework](/workflow/overview) based workflows only. With old UI based workflows, our old
