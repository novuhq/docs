...
The `icons` property in the `appearance` prop allows you to customize any icon used within the Inbox component. This is useful when you want to:
- Match the Bell icon with your host app's navbar icon set
- Use your own icon library to maintain a consistent design system
- Modify all icons to fit your application's visual style

Each icon is identified by a unique key, and you can provide a custom renderer function for each icon you want to override.
...
<TypeTable
  type={{
    bell: {
      type: 'IconRenderer',
      description: 'The notification bell icon in the header.',
    },
    clock: {
      type: 'IconRenderer',
      description: 'Used in the date/time display for notifications.',
    },
    arrowDropDown: {
      type: 'IconRenderer',
      description: 'Dropdown arrow in various menus and selectors.',
    },
    dots: {
      type: 'IconRenderer',
      description: 'More options menu (three dots) in notification items.',
    },
    markAsRead: {
      type: 'IconRenderer',
      description: 'Icon for marking notifications as read.',
    },
    cogs: {
      type: 'IconRenderer',
      description: 'Settings/preferences icon in the header.',
    },
    trash: {
      type: 'IconRenderer',
      description: 'Delete/remove icon for notifications.',
    },
    markAsArchived: {
      type: 'IconRenderer',
      description: 'Icon for archiving notifications.',
    },
    markAsArchivedRead: {
      type: 'IconRenderer',
      description: 'Icon for marking notifications as archived and read.',
    },
    markAsUnread: {
      type: 'IconRenderer',
      description: 'Icon for marking notifications as unread.',
    },
    markAsUnarchived: {
      type: 'IconRenderer',
      description: 'Icon for unarchiving notifications.',
    },
    unsnooze: {
      type: 'IconRenderer',
      description: 'Icon for unsnoozed notifications.',
    },
    arrowRight: {
      type: 'IconRenderer',
      description: 'Right arrow used in pagination and navigation.',
    },
    arrowLeft: {
      type: 'IconRenderer',
      description: 'Left arrow used in pagination and navigation.',
    },
    unread: {
      type: 'IconRenderer',
      description: 'Indicator for unread notifications.',
    },
    sms: {
      type: 'IconRenderer',
      description: 'SMS channel icon in notification preferences.',
    },
    inApp: {
      type: 'IconRenderer',
      description: 'In-app channel icon in notification preferences.',
    },
    email: {
      type: 'IconRenderer',
      description: 'Email channel icon in notification preferences.',
    },
    push: {
      type: 'IconRenderer',
      description: 'Push notification channel icon in preferences.',
    },
    chat: {
      type: 'IconRenderer',
      description: 'Chat channel icon in notification preferences.',
    },
    check: {
      type: 'IconRenderer',
      description: 'Checkmark icon used for selected items.',
    },
    arrowDown: {
      type: 'IconRenderer',
      description: 'Down arrow used in dropdowns and expandable sections.',
    },
  }}
/>
...
You can inspect the elements you want to customize using the browser's dev tools. Icon elements have a class name with a 🖼️ emoji followed by a class similar to `nv-cogs`. The part after `nv-` is the icon key that you can use to override that icon.

<img src="/images/inbox/styling_02@2x.png" alt="Finding Icon Keys" />

<Callout type="info">
  Any selector that starts with `nv-` and has a 🖼️ emoji can be customized using the corresponding icon key in the `appearance.icons` property.
</Callout>

#### Customizing icons with React components

The simplest way to customize icons is to provide a function that returns a React component for each icon you want to override:

```tsx
import { Inbox } from '@novu/react';
import { RiCogs, RiArrowDown, RiBellFill } from 'react-icons/ri';
...
Your custom icon renderer function can also accept and use the props passed to it, such as className:
...
const appearance = {
  icons: {
    cogs: (props) => <RiCogs className={props.class} />,
    arrowDown: (props) => <RiArrowDown className={props.class} />,
    bell: (props) => <RiBellFill className={props.class} />
  },
};
