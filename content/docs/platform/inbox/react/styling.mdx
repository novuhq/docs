...
- [Custom Composition](/docs/inbox/react/components/overview#composition) - Compose our components for custom layouts
...
<img src="/images/inbox/Variables Inbox.png" alt="Appearance Variables" />
...
<img src="/images/inbox/Elements.png" alt="Finding Element Selectors" />
...
You can learn more about the Novu Framework in-app step [here](/docs/framework/typescript/steps/inApp).
