...
<img src="/images/inbox/multiple-tabs.png" alt="Multiple Tabs in Inbox" />

<Callout type="info">
  Here tab `filter.tags` are taken from workflow tags. Tags can be configured in options field of
