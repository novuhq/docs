---
pageTitle: "Novu Integrations Overview - channel integration setup guide for Novu notification delivery"
title: 'Overview'
...
<Callout type="info">Novu providers demo integrations. To learn more about how to use them for testing, see the [Demo Integration](/platform/integrations/demo-integration) guide.</Callout>
