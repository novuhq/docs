...
<Callout type="info">
  Check out the [agents](/connect) documentation for more information on how to build agents using Microsoft Teams.
</Callout>

## Prerequisites

- Access to <a href="https://portal.azure.com/" target="_blank" rel="noopener noreferrer">Azure Portal</a> with App Registration permissions.
- Access to <a href="https://dev.teams.microsoft.com/home" target="_blank" rel="noopener noreferrer">Microsoft Teams Developer Portal</a>
- Administrator privileges for granting API permissions
- Access to <a href="https://dashboard.novu.co" target="_blank" rel="noopener noreferrer">Novu dashboard</a>
...
1. Open the <a href="https://teams.microsoft.com/v2/" target="_blank" rel="noopener noreferrer">Teams client</a> (desktop or web).
...
12. Under **Select the scopes where people can use your bot**, enable the scopes based on your use case:
      ...
      - **Group chat**
13. Click **Save**.
14. In the top right, click **Distribute** and then click **Download the app package**. This will save a copy of the app package to your computer in ZIP format.
...
Follow the steps in the <a href="https://learn.microsoft.com/en-us/microsoftteams/platform/concepts/deploy-and-publish/apps-upload#upload-your-app" target="_blank" rel="noopener noreferrer">Microsoft Teams documentation</a> to learn how to upload the just downloaded app package and also how to add the app to a specific location.
...
<Callout type="info" title="Try the Microsoft Teams integration with a demo app">If you’ve completed the previous steps, you can test your bot configuration end to end with this <a href="https://github.com/novuhq/ms-teams-example" target="_blank" rel="noopener noreferrer">demo app</a>.</Callout>
