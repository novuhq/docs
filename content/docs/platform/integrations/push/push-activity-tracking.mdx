...
When push notifications are delivered or interacted with, your app must capture those events and forward them to your backend. The exact code implementation depends on the push provider that you use.
