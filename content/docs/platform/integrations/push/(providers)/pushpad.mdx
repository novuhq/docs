...
This guide walk you through the entire process of configuring and using <a href="https://pushpad.xyz" target="_blank" rel="noopener noreferrer">Pushpad</a> with Novu, from getting your credentials to sending your first notification.
...
To configure the Pushpad integration, you need an active account and you need to have a Pushpad auth token (from the [account settings](https://pushpad.xyz/access_tokens)) and your Pushpad project ID (from the project settings).
...
3. Click **Settings** on the project page and copy the **Project ID**, you need it to connect to Novu.
...
6. Copy the generated token, you need it to connect to Novu
