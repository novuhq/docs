...
4.  Under the **Push** tab, select **Pushpad**.
5.  In the Pushpad integration form, paste your Access token and project from [Step 1](/platform/integrations/push/pushpad#step-1-get-your-pushpad-credentials) into the corresponding fields.
...
Now you're ready to send a push notification. Create a workflow with a Push step in the editor and trigger it. Novu will send the notification to the `uid`'s associated with the subscriber.
