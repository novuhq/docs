...
<Accordions type="multiple">
  <Accordion title="FCM cost">As per Firebase <a href="https://firebase.google.com/pricing" target="_blank" rel="noopener noreferrer">pricing</a>, **Cloud Messaging** product is free of cost to use. If other Firebase products are used, then the cost are charged per the product.</Accordion>
