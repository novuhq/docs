---
pageTitle: "How To Integrate Segment With Novu"
title: "Integrate with Segment"
...
To successfully send a payload to Novu, triggering the appropriate [workflow](/docs/concepts/workflows) and delivering it to the correct customer, please ensure that you provide the following information:
