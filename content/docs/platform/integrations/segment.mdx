...
<Callout type="info">
  Want to see some example functions? Check out the templates available in the Functions UI, or in
  the open-source Segment Functions Library.
</Callout>
...
<Callout type="info">
  Your function isn’t invoked for an event if you’ve configured a destination filter, and the event
...
<Callout type="info">
  ...
  [here](https://github.com/novuhq/segment-novu-destination-scripts). Feel free to submit your
  function examples as well!
</Callout>
