...
To help you evaluate our services better, Novu provides an email and sms demo providers by default for every account. After signing up, you can go to the [Integrations store](https://dashboard.novu.co/integrations?utm_campaign=docs-default-providers) on the Novu web dashboard to see this.
