...
<Steps>
  ...
  <Callout type="info">
By default, the Email channel is enabled and configured with Novu's default provider. If it is disabled, notifications sent to this channel will not be processed.
</Callout>
