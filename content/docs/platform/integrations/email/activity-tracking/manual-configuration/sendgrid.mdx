...
3. You should see that the webhook was already created successfully in SendGrid despite the error.  
4. Copy the **Endpoint URL** from this page and return back to the Novu Dashboard 
   ![Copy the Endpoint URL](/images/channels-and-providers/email/activity-tracking/sendgrid-endpoint-url.png)
5. Go to your Novu SendGrid integration settings, under **Email Activity Tracking**, paste the Endpoint URL into the **Inbound Webhook Signing Key** field. 
6. Click **Save**.
