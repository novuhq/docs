...
title: 'Mailgun'
description: 'Learn how to manually add specific event webhooks in Mailgun to enhance your Novu activity tracking.'
---
...
2. Navigate to the **Integration Store** page in Novu and select your **Mailgun** integration.
