---
pageTitle: "Email Activity Tracking"
...
| Novu status    | Meaning                                                                               |
| -------------- | ------------------------------------------------------------------------------------- |
| `blocked`      | The provider refused to send the message because the recipient is on a suppression or block list (for example, SendGrid’s blocked event). |
