...
Novu has its own SMS editor for writing SMS template. To use premade Gupshup templates, customData field of sms overrides can be used to send templateId.
