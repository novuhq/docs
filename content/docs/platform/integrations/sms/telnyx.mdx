...
2. Create a Telnyx Messaging Profile if you haven't already ([learn more](https://developers.telnyx.com/docs/v2/messaging/quickstarts/portal-setup))
...
<Callout type="info">
A valid from address must be one of:
- A valid phone number in +E.164 format
- A short code
- An alphanumeric sender ID that:
  - Is 1-11 characters long
  - Contains only ASCII letters, numbers, and spaces
  - Has at least one letter
</Callout>
</Step>

<Step title="Connect Telnyx to Novu">
1. Visit the [Integrations](https://dashboard-v2.novu.co/integrations) page on Novu
