...
Inbound webhooks let Novu receive and process real-time events sent by third-party providers such as SendGrid, Amazon SES, Mailgun, and Resend. These events describe what happens to notifications after they sent by Novu, such as, when an email is delivered, opened, clicked, or bounced.
...
You need to first [create the integration](/platform/integrations/email/adding-email) first before you can able to enable inbound webhook, after you have done that, follow these steps
