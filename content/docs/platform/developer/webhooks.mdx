...
- **messages.sent**: Triggered when a message is sent.
- **messages.delivered**: Triggered when a message is delivered.
- **messages.read**: Triggered when a message is read.
- **messages.unread**: Triggered when a message is unread.
- **messages.failed**: Triggered when a message delivery fails.
...
- **preference.updated**: Triggered when a preference is updated
