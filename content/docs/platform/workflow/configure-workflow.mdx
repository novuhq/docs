...
<Callout>To learn more about how notification content are added to the template editors, refer to the [Add notification content](/platform/workflow/add-notification-content) documentation</Callout>
