...
Novu allows you to mark a workflow as critical, this means that the notification sent from that worflow must always be delivered to the subscribers regardless of their personal preferences and they cannot change their preferences for this workflow.
