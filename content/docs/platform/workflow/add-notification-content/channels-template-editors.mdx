...
<Callout>Variables autocomplete is supported in all channel template editors</Callout>
...
<Callout type="info"> On the Free plan, only one layout can be created per environment. Pro and higher plans support up to 100 layouts per environment. If you need more than 100 layouts, please [contact Support](mailto:support@novu.co).</Callout>
