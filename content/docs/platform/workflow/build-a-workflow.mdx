...
2. In the workflow editor, go to the **Configure workflow** section and select **Configure channel preferences**.
   ![](/images/workflows/notification-workflows/configure-notification-severity.png)
3. Choose the desired severity level option from the **Notification severity** dropdown menu.
