...
You can define the expected payload in three ways, manually, by importing a sample or incline. When adding or editing a schema property, you can also mark it as required.
