...
You have the option to enforce schema validation for any workflow. When this is enabled, Novu validates incoming payloads against your defined schema when the workflow is triggered.
