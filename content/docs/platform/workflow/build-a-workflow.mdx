...
<Steps>
  ...
  <Step title="Add a workflow step">
    ...
    **Actions**
        - Digest
        - Delay
        - Custom (Coming soon, currently only available in the [Novu Framework](/docs/framework/custom))
  </Step>
...
[Learn more about promoting workflows to production](/docs/framework/deployment/production)
</Step>
</Steps>
