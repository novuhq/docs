...
- Click on the `cog` icon on layout editor to modify layout name or identifier
- Use the block or code editor to modify the layout content
- Preview your layout using preview screen, which allows you to test with mock subscriber data
