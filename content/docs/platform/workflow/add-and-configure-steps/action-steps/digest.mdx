...
<Callout>To learn about the when to use Digest in a workflow, refer to the [Digest step overview](/platform/workflow/add-and-configure-steps#digest).</Callout>
...
You can configure the digest duration in from the **Digest events for** field:
- Seconds
- Minutes
- Hours
- Days
