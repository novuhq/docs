...
![Fixed window](/images/workflows/add-and-configure-steps/action-steps/throttle/fixed-window.png)
...
![Dynamic window](/images/workflows/add-and-configure-steps/action-steps/throttle/dynamic-window.png)
