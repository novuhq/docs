---
pageTitle: "How to configure Throttle Step"
...
<Callout>To learn when to use the Throttle step in a workflow, refer to the [Throttle step overview](/platform/workflow/add-and-configure-steps#throttle).</Callout>
