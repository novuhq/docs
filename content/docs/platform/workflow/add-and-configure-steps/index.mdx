...
Each step operates independently. If one step fails, other steps in the workflow can still succeed, making workflows modular and fault-tolerant. Novu workflows support two types of steps from the Novu dashboard.
