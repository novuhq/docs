---
pageTitle: "How to configure code steps in a workflow"
title: 'Code Steps'
...
If the bundle content changed, Novu deploys a new version.
...
| Purpose | Content overrides (subject lines, toggles, copy) | Dynamic data (user name, order ID, etc.) |
