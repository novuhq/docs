...
For more complex scenarios where you need to perform advanced calculations based on your application state, you can use the [Novu Framework Skip Step](/docs/framework/typescript/steps/overview). 
