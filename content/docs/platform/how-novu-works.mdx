...
Each channel connects to a specific delivery [provider](/platform/additional-resources/glossary#providers) that handles the actual notification delivery.
...
<Steps>
  <Step title="Configure one or more channels by selecting and setting up providers">
    ...
    notification workflows. Each [channel](/platform/workflow/channel-steps) corresponds to a configured
