...
<Steps>
  <Step title="Configure one or more channels by selecting and setting up providers">
    ...
    notification workflows. Each [channel](/workflow/channel-steps) corresponds to a configured
    provider that you can use to deliver notifications in production.
  </Step>
...
<Accordion title="SMS" icon="message-sms">
  ...
  channel →](/integrations/providers/sms/overview)
</Accordion>
...
<Accordion title="Push Notifications" icon="mobile">
  ...
  Android. [Learn more about Push channel →](/integrations/providers/push/overview)
</Accordion>
...
<Accordion title="Chat Platforms" icon="message">
  ...
  Chat channel →](/integrations/providers/chat/overview)
</Accordion>
