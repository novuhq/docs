...
<img src="/getting-started/media-assets/how-novu-works.png" alt="How Novu works" className="rounded-lg border" />
...
<div className="rounded-lg border-l-4 border-yellow-500 bg-yellow-50 p-4 dark:bg-yellow-950">
  <div className="text-sm text-yellow-700 dark:text-yellow-400">
    ...
    <ul className="mt-2 list-disc pl-4">
      ...
      <li>Maintain separate content formats and hydration methods for each channel and notification type</li>
    </ul>
  </div>
</div>
...
<div className="rounded-lg border-l-4 border-green-500 bg-green-50 p-4 dark:bg-green-950">
  <div className="text-sm text-green-700 dark:text-green-400">
    ...
    <ul className="mt-2 list-disc pl-4">
      ...
      <li>Power real-time notification feeds with our <a href="/inbox/overview" className="underline">full-stack UI Components libraries</a></li>
      <li>Handle notification templates and workflows</li>
    </ul>
    <p className="mt-2">And much more.</p>
    <p className="mt-2 font-medium">This is a robust, highly customizable infrastructure layer that sits between your application and the user's devices and channels.</p>
  </div>
</div>
...
Every request you make is automatically routed to the correct [environment](/docs/concepts/environments), ensuring clear separation between **development** and **production** environments.
...
Using intuitive logical operators and [action steps](/docs/concepts/workflows#action-step), you can create dynamic notification paths that automatically adapt based on your [end user](/docs/additional-resources/glossary#subscribers) preferences and behavior.
...
<img src="/getting-started/media-assets/novu-workflow.png" alt="Novu Workflows" className="rounded-lg border" />
...
<div className="not-prose">
  <div className="rounded-lg border">
    <div className="border-b">
      <nav className="flex gap-4 px-4" aria-label="Code examples">
        <button className="border-b-2 border-primary py-4 font-medium text-primary">cURL</button>
        <button className="py-4 font-medium text-muted-foreground">Node.js</button>
        <button className="py-4 font-medium text-muted-foreground">Python</button>
        <button className="py-4 font-medium text-muted-foreground">Java</button>
        <button className="py-4 font-medium text-muted-foreground">PHP</button>
        <button className="py-4 font-medium text-muted-foreground">Ruby</button>
        <button className="py-4 font-medium text-muted-foreground">Go</button>
        <button className="py-4 font-medium text-muted-foreground">.NET</button>
      </nav>
    </div>
    <div className="p-4">
```bash
...
To deliver notifications to subscribers, you need to configure a [channel](/docs/additional-resources/glossary#channels).

A channel in Novu is a configured delivery method for sending notifications to subscribers. 
Each channel connects to a specific delivery [provider](/docs/additional-resources/glossary#providers) that handles the actual notification delivery.
...
<Steps>
  <Step title="Configure one or more channels by selecting and setting up providers">
    ...
    Each [channel](/docs/workflow/channel-steps) corresponds to a configured provider that you can use to deliver notifications in production. 
  </Step>
...
<Accordions>
 <Accordion title="Email" icon="envelope">
   ...
   [Learn more about email channel →](/docs/integrations/providers/email/overview)
 </Accordion>
 ...
 <Accordion title="SMS" icon="message-sms">
   ...
   [Learn more about SMS channel →](/docs/integrations/providers/sms/overview)
 </Accordion>
 ...
 <Accordion title="Push Notifications" icon="mobile">
   ...
   [Learn more about Push channel →](/docs/integrations/providers/push/overview)
 </Accordion>
 ...
 <Accordion title="Chat Platforms" icon="message">
   ...
   [Learn more about Chat channel →](/docs/integrations/providers/chat/overview)
 </Accordion>
 ...
 <Accordion title="In-app Notifications" icon="bell">
   ...
   [Learn more about In-app channel →](/docs/integrations/providers/in-app/overview)
 </Accordion>
</Accordions>
...
Each workflow can combine multiple action steps to model complex logic that creates better notification experiences. You can combine the following action steps with any number of channel steps to create personalized notifications for your users:
    ...
    [Learn more about Digest action →](/docs/workflow/digest)
    ...
    [Learn more about Delay action →](/docs/workflow/delay)
    ...
    [Learn more about Custom action →](/docs/workflow/custom)
...
Novu automatically enforces user communication [preferences](/docs/concepts/preferences) during workflow execution, while giving developers full flexibility to customize how these preferences are displayed and which options are available to users.
...
<Cards>
  ...
  <Card 
    ...
    description="Extend your workflows past the UI to accomplish any use case imaginable."
  />
  <Card 
    href="/sdks/overview"
    title="Novu Framework SDK"
    description="Use our SDK to integrate Novu with your backend codebase."
  />
  <Card 
  ...
  <Card 
    ...
    title="Local Studio"
    description="Use our local studio to design and test your notification templates."
  />
  <Card 
