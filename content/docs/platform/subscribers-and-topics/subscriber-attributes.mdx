...
Each subscriber is represented as a structured object, following a defined schema. The schema includes, the user attributes, the data field to store any custom attributes in key value pairs and channel credentials for push and chat channel provider's integrations.
