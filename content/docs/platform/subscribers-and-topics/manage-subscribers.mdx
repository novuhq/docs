...
2. Navigate to **Subscribers** page in the Novu dashboard.
3. Click on the **Add subscriber** or **Create subscriber** button.
  ![Create a Subscriber](/images/manage-subscribers/create-subscriber.png)
4. Fill in the subscriber details such as `subscriberId` (this is required), first name, last name, email, phone number, and locale.
...
5. Click on **Create subscriber** button to save the subscriber profile.
