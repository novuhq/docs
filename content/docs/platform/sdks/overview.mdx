...
<Cards cols={2}>
  <Card title="Node.js (Official)" icon={<NodejsIcon />} color="#ea5a0c" href="/platform/sdks/server/nodejs">
...
<Cards>
  <Card title="React" icon={<ReactIcon />} href="/inbox/react/get-started">
    Official React SDK for Novu's notification center
  </Card>
  <Card title="Headless" icon={<JavascriptIcon />} href="/inbox/headless/get-started">
    Framework-agnostic SDK for custom implementations
  </Card>
  <Card title="React-Native" icon={<ReactIcon />} href="/inbox/react-native/quickstart">
