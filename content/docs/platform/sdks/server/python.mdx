...
<Card title="Poetry">
  Poetry is a modern tool that simplifies dependency management and package publishing by using a
  single pyproject.toml file to handle project metadata and dependencies. ```bash poetry add novu-py
  ```
</Card>

  <Card title="Shell and script usage with uv">
