...
The `useCounts` hook provides a way to fetch various notification counts, including unread, unseen, total counts, and now counts filtered by severity. This hook is useful for displaying notification badges and indicators in your application.
