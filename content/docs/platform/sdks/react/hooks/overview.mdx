...
<Steps>
  ...
  <Step title="Implement the NovuProvider">
    To implement the [NovuProvider](/docs/inbox/react/hooks/novu-provider) component, you need to place it in your application's code at the tree level where you want the hooks to be accessible.
