...
Subscriptions can be managed at two levels:
...
---type-table---
../types/js-types.ts#ListSubscriptionsArgs
---end---
...
---type-table---
../types/js-types.ts#GetSubscriptionArgs
---end---
...
---type-table---
../types/js-types.ts#CreateSubscriptionArgs
---end---
...
---type-table---
../types/js-types.ts#UpdateSubscriptionArgs
---end---
...
---type-table---
../types/js-types.ts#DeleteSubscriptionArgs
---end---
...
---type-table---
../types/js-types.ts#TopicSubscription
---end---
...
#### Update a subscription preference

Each subscription contains a list of `SubscriptionPreference` objects that can be updated individually.

---type-table---
../types/js-types.ts#SubscriptionPreference
---end---
