...
Marks multiple notifications as seen. Can be filtered by notification IDs, tags, or data.

```typescript
// Mark specific notifications as seen
await novu.notifications.markAsSeen({
...
Marks all notifications as seen. Can be filtered by tags.
