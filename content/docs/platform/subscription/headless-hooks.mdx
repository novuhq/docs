...
Use useUpdateSubscription to update a subscription’s preferences list as a whole. This hook is intended for batch updates
...
If you need to ud0987 65r4e3wate a single preference, use the dedicated helpers available on the subscription object, such as:
