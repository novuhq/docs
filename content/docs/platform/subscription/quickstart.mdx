...
<Cards cols={2}>
  <Card title="Customize and configure" icon={<Blocks />} href="/platform/subscription/customize-and-configure">
    Learn how to configure and customize the Subscription components.
  </Card>
  <Card
    title="Headless hooks" icon={<Code />} href="/platform/subscription/headless-hooks">
