...
As a workflow triggered to one subscriber is billed as 1 event. if events are digested 15 times and digested notification is sent 15th time, then 15 events will be billed.