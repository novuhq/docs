...
**Action step** is a purpose built functions that help manage the workflow flow. **Action Step** can be executed before and after **Channel step**.
...
<Cards>
  <Card
    title="Order or transaction updates"
    description="Notifications for orders, shipping, or subscription statuses"
  />
  ...
  <Card
    ...
    description="Notifications for product updates, new features, and more"
  />
  <Card
    title="Abandoned cart recovery"
    description="Notifications for abandoned carts and follow-up emails"
  />
  <Card
    title="Password reset"
    description="Notifications for password resets and follow-up emails"
  />
  <Card
    title="Administrative actions"
    description="Notifications for administrative actions like account deletions and more"
  />
