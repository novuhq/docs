---
title: 'Preferences'
pageTitle: "Notification Preferences Concepts"
...
For each workflow, each subscriber has their own channel preferences. Subscribers can manage these preferences from the <Method href="/platform/inbox/configuration/preferences">{`<Inbox />`}{" "}</Method> Preferences view.
