...
When [building new workflows](/docs/workflow/overview), you will be using the [Novu Framework SDK](/docs/framework/typescript/overview) to define the workflows and their steps directly in your IDE. The local workflows can be previewed and tested using our [Local Studio](/docs/framework/studio) companion app.
...
Once synced, you will be able to view the workflows in the workflows Page on the Dashboard. All the controls created using JSON Schema or Zod will be transformed into UI elements that can be modified without changing the source code. Read more about controls [here](/docs/framework/controls).
...
<Cards>
  <Card title="Next.js" href="/docs/framework/quickstart/nextjs" />
  <Card title="Express.js" href="/docs/framework/quickstart/express" />
  <Card title="Remix" href="/docs/framework/quickstart/remix" />
  <Card title="NestJS" href="/docs/framework/quickstart/nestjs" />
  <Card title="Svelte" href="/docs/framework/quickstart/svelte" />
  <Card title="Nuxt" href="/docs/framework/quickstart/nuxt" />
  <Card title="H3" href="/docs/framework/quickstart/h3" />
  <Card title="Lambda" href="/docs/framework/quickstart/lambda" />
</Cards>
