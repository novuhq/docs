---
title: 'React Router'
pageTitle: 'Novu React Router Quickstart Guide'
...
This guide walks you through integrating Novu’s Inbox into your React Router application for in-app notifications in real-time, from setup to triggering your first notification. By the end, you'll have a working notification inbox.
...
<Steps>
  ...
  Run the command below to install React Router Dom and [Novu React SDK](/platform/sdks/react), which provides React components for building notification UIs:
