...
<Cards cols={2}>
  ...
  <Card title="Multi-tenancy" icon={<Users2 />} href="/platform/concepts/tenants">
    Manage multiple tenants within an organization.
  </Card>
  <Card title="Localization" icon={<Globe2 />} href="/platform/inbox/react/localization">
  ...
  <Card title="Environments" icon={<Layers />} href="/platform/concepts/environments">
