...
<Steps>
  ...
  ### Add the notification Inbox to your app
    ...
    * `subscriberId`: This represents a user in your system, usually the user ID from your database. For this quick start, you can use the auto-generated `subscriberId` for your dashboard user.
