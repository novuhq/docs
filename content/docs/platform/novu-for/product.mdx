---
pageTitle: "No-Code tools to manage your notifications"
title: "Product"
...
- **Non-Developers** - Use the Novu Dashboard UI to control the content and behavior of the notifications using [controls](/docs/framework/controls).
