...
- **[Prebuilt, customisable UI components](/platform/inbox/introduction)** for in-app user notification feeds and preference experiences.
- **[Integration with multiple delivery providers](/platform/integrations/introduction)**, allowing you to continue using your preferred vendors with Novu.
