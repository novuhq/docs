...
<Callout type="info" title="Beta Feature">
  Webhooks are currently in beta. If you encounter any issues, please reach out to our support team.
</Callout>
...
For example, if you receive webhooks from Novu, you can structure your URL like: `https://www.example.com/novu/webhooks/`.
...
- **Workflow Events**: Notifications about workflow creation, updates, and deletions
- **Subscriber Events**: Notifications about subscriber creation, updates, and preference changes
- **Message Events**: Notifications about message delivery status changes
...
You'll be able to view and inspect webhooks sent to these testing URLs, making it effortless to get started.
...
<Accordions>
  <Accordion title="Common reasons why your webhook endpoint is failing">
  ...
  <Accordion title="Re-enable a disabled endpoint">
  ...
  <Accordion title="Recovering/Resending failed messages">
