...
Install the skills from the [novuhq/skills](https://github.com/novuhq/skills) GitHub repository and point your AI agent to the relevant `SKILL.md` file for the task at hand.
