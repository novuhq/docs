...
<Callout type="info">
  ...
  platform](https://dashboard-v2.novu.co/?utm_campaign=docs_account_authentication). For more
...
<Steps>
  ...
  <Step title="Compliance and security">
    Meets stringent security standards, protecting sensitive data and ensuring regulatory
    compliance.
  </Step>
