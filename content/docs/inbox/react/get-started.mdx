...
<Steps>
  ...
  <Step title="Add the inbox code to your react file">
    ...
    <Accordion items={[
      {
        title: 'European Region Instructions',
        content: <>
...
<Accordion items={[
  {
    title: 'The Inbox is not loading properly.',
    content: <>
  ...
  {
    title: 'How to fix CORS error with Inbox?',
    content: 'Our Inbox is configures for all hosts. Please disable root level `withCredentials` config in axios or fetch http requests.'
  }
]} />
