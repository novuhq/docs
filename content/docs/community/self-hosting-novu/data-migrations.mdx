...
- warning: some migrations do not exit properly ( eg < 0.19.0 ) and require Ctrl-C to finish and continue
...
| [`v0.19.0`](https://github.com/novuhq/novu/releases/tag/v0.19.0) | 2023-09-01       | `integration-scheme-update` *(Multi-Provider)* <br> `layout-identifier-update` *(Add layout identifier)*                                                                                                                                                                                                                                                                         |
...
| [`v2.0.1`](https://github.com/novuhq/novu/releases/tag/v2.0.1)   | 2024-11-11       | `preference-centralization` *(Preference model centralization)*                                                                                                                                                                                                                                                                                                                  |
...
- If you want to know which tags are availabel: `git tag`
- Because migrations don't change, in practice having latest source will be good enough
...
VERSIONS="v0.17.2 v0.18.0 v0.19.0 v0.23.0 v0.24.0 v2.0.0 v2.0.1 Future"
...
MIGRATION_MAP_v0_19_0="integration-scheme-update layout-identifier-update"
...
get_migration_path() {
  case "$1" in
    ...
    subscribers) echo "subscribers/subscribers.migration.ts" ;;
    preference-centralization) echo "preference-centralization/preference-centralization.migration.ts" ;;
    deleteLogs) echo "deleteLogs/delete-logs.migration.ts" ;;
    *) echo "" ;;
  esac
}
