---
pageTitle: 'Get involved with the Novu Community'
title: 'Get Involved'
...
- Once you've gone through our [development process](/docs/community/run-in-local-machine), you can contribute directly to open issues.
