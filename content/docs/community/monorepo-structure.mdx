...
For additional information on running Novu locally, visit the [run locally](/docs/community/run-in-local-machine) guide.
...
- [Novu](/docs/integrations/providers/in-app/overview)
