...
description: "A comprehensive, step-by-step guide to effortlessly migrating your notification stack from Courier to Novu."
---

import { Tab, Tabs } from 'fumadocs-ui/components/tabs';

> Looking to move your notification infrastructure to Novu? This guide is designed to make your transition from Courier as smooth and hassle-free as possible.

Transitioning between infrastructure platforms can feel daunting, but migrating from Courier to Novu is a straightforward process. 

Whether your team prefers building visually in a dashboard or writing notifications entirely in code, Novu adapts to your workflow. This guide breaks down the conceptual differences and provides a clear, step-by-step migration playbook.
...
Before we dive into the migration steps, here is a quick cheat sheet for translating your Courier setup into Novu's terminology.
...
<Steps>
  <Step title="Phase 1: Set up your Workspace & Providers">
  ...
  <Step title="Phase 5: Update API Triggers & Cut Over">
...
<Cards cols={2}>
  <Card title="Quickstart Guide" icon="bolt" href="/platform/quickstart/react">
    Get up and running with Novu in under 5 minutes.
  </Card> 

  <Card title="Inbox Integration" icon="bell" href="/platform/inbox/overview">
    Add a real-time notification center to your application.
  </Card>

  <Card title="Explore Novu Framework" icon="code" href="/framework/overview">
  ...
  <Card title="API Reference" icon="server" href="/api-reference/overview">
    Deep dive into Novu's REST endpoints and SDKs.
  </Card>
</Cards>
