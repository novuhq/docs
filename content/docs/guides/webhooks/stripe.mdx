...
You'll learn how to automatically trigger notification workflows when **any Stripe event** occurs, such as **payment, subscription, customer creation**.

## Overview

When specific events happen in Stripe (e.g., payment, subscription, customer creation), this integration will:
