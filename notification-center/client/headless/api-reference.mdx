...
Fetches the user [preferences](/subscribers/preferences)
...
Updates the user [preferences](/subscribers/preferences).
...
remove a single notification using the message id.
...
remove multiple notifications using array of message ids.
