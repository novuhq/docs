...
## Code SandBox Live Example

[Link 🔗](https://codesandbox.io/s/novu-web-component-esm-rltcr5)
...
| tabs                       | object[] | The array of items that do describe the tabs/feeds, they are bound with the stores property. More information can be found https://docs.novu.co/notification-center/react/react-components/#multiple-tab-layout.                                                                                                    |
...
# Limitations[](https://docs.novu.co/notification-center/web-component#limitations)
