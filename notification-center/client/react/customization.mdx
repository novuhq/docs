...
`<PopoverNotificationCenter>` is a pre built notification center component that can be used to show notifications in your application. It is a popover component that can be placed anywhere in your application. A bell will appear on the page. On click of that bell, a popover will appear. All possible customizations and props are available [here](/notification-center/client/react/api-reference#popovernotificationcenter). If you are looking for a component without popover use regular `<NotificationCenter>` component. Props of this component can be found [here](/notification-center/client/react/api-reference#notificationcenter). Few selected customization options are explained below:-
...
`styles` prop can be used to cutomise styling of each component of notification center. Read more about styles prop [here](/notification-center/client/react/api-reference#styles)
