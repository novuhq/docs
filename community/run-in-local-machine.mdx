...
<Note>We recommend to have at least 8GB of ram to run Novu in local machine as Novu has multiple services running together with external services like redis, mongodb etc.</Note>
### Setup the project
