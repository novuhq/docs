...
Here’s an improved version of your write-up with additional details and clarification:

---

## Local Tunnel and Self-Hosted Deployments

Local tunnel support is not included as part of the Novu Docker images. This is typically unnecessary for many users, depending on how their environment is structured.
...
If the application and Novu deployment reside on different networks, you can still interact with your self-hosted Novu instance using the Novu CLI without requiring a local tunnel. The CLI allows you to specify the Dashboard URL and Bridge Endpoint Origin to enable communication across networks. 
