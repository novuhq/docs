...
- `STORE_ENCRYPTION_KEY`: Used to encrypt/decrypt the provider credentials. Must be 32 characters long
...
npx novu@latest dev -d http://<vps-ip-address>:4200 -o http://<novu-bridge-ip>:4000  # where your bridge application runs
```
