---
title: 'Workflows'
description: 'Here you larn all about workflows'
icon: 'sitemap'
---
...
<Check>**Each Workflow comprises the following components**</Check>
...
With the new seen/read filter, you can do the following in a workflow:
