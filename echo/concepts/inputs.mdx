---
title: "Workflow and Step Inputs"
sidebarTitle: "Inputs"
---

Inputs are defined using [JSON Schema](/echo/recipes/json-schema), providing a strong run-time validation system for your workflows.
