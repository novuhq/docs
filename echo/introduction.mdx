...
Echo introduces a new networking paradigm when working with Novu. Rather than being constrained to utilize Novu’s prebuilt connectors, Echo enables you to connect with your existing environment, granting flexibility to use your own libraries and connect to your own VPC during the Workflow execution.
