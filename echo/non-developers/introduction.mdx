...
description: "Change notification content and behaviour with confidence using Novu Web UI."
---
...
- **Non-Developers** - Use the Novu Web UI to control the content and behaviour of the notifications using [Inputs](/echo/concepts/inputs).

## How to Modify Inputs?

Inputs are modified directly on the [Novu Web UI](https://web.novu.co). Each Echo Workflow editor page have an 'Inputs' tab where you can modify them.
