...
<Frame caption="Choose the email to which you want to send the notification"><img src="/images/run-a-test.png" /> </Frame>
...
<Note>
Instead of having static messages, you can have your notifications be dynamic by using `handlebars`. Take a look [here](/content-creation-design/handlebars-helpers) for more. If your backend is expecting data in the payload, plug that variable here in double braces.
</Note>
