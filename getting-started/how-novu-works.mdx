...
- Maintain seprate content formats and hyfration methods for each channel and notification type
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Novu Framework" icon="code" href="/framework/quickstart/overview">
