...
---
In this section, we'll dive into how Novu works.
...
One of the key functions of the Novu API is to trigger workflows.
...
A channel in Novu is your configured delivery method for sending notifications to subscribers. 
Each channel connects to a specific provider that handles the actual notification delivery.

**To send notifications through Novu:**

<Steps> 
  <Step title="Configure one or more channels by selecting and setting up providers"> 
    Novu allows you to set up multiple notification [providers](/concepts/providers) and integrate them into your notification workflows. 
    
    Each [channel](/concepts/channels) corresponds to a configured provider that you can use to deliver notifications in production. 
  </Step> 
...
Novu allows you to design notification templates using an intuitive combination of template editor and the Liquid templating language to create dynamic, customizable notification templates.
...
<Steps>
  <Step title="The need for multiple templating languages">
    ...
    <Check> **A consistent, efficient workflow across all channels without the need for constant adjustments.** </Check>
  </Step>
  <Step title="Managing Notification Templates in your application codebase">
    ...
    <Check> **This separation from your codebase lets non-developers update and manage communications without needing developer intervention.** </Check>  
  </Step>
</Steps>

---

Adding action functions to your workflows is a powerful way to create more complex and unique notification experiences for your users. 
...
True to the Novu mission to facilitate meaningful communications between products and users, we believe that the best way to address this is to empower the user to decide what, when, and how they want to receive notifications.
