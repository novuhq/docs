...
This section provides a broad overview of Novu's functionality, delving into key concepts for your initial Novu journey. If you prefer to dive into development, explore our **[Quick Start guides](/quickstarts/01-introduction)**.
