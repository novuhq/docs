...
<Icon icon="sparkles" size="34" iconType="solid" /> **How does it work?**

Managing notifications across multiple channels is painful. Each notification delivery provider has their own SDK, authentication methods, and API quirks. 
...
## Step Conditions 
 ...
 <Icon icon="hourglass-clock" size="25" iconType="solid" /> **Coming Soon...**
