...
<Frame caption="Choose 'blank workflow'"><img src="/images/blank-workflow.png" /> </Frame>
...
<Frame caption="Drag email to the workflow"><img src="/images/workflow-editor.png" /> </Frame>
4.Now, simply click on the email node, add the subject and the notification text in the email node editor:
<Frame caption="Add subject and notification text in the email node editor'"><img src="/images/email-node.png" /> </Frame>
