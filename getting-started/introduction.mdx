...
<CardGroup cols={1}>
    <Card title="Quick Start" icon="play" color="#00D7FE" href="/framework/quickstart">
        Create a Novu Workflow, and send your first email authored with React Email in a few minutes.
    </Card>
</CardGroup>
