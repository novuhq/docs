...
- [Inbox](/channels-and-providers/in-app/introduction)
...
- **[Code-first Notification Framework](/api-reference/overview)** Opinionated, yet flexible, Framework for building and managing notification workflows.
