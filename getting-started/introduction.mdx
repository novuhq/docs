...
Notification content can be written in a variety of common content tooling, including [React](/framework/integrations/react-email), [Vue-email](/framework/integrations/vue-email), [MJML](/guides/framework-guides/echo-mjml), and more. Content can also be customized and hydrated using any datasource.
