...
Notification content can be written in a variety of common content tooling, including [React](/echo/integrations/react-email), [Vue-email](/echo/integrations/vue-email), [MJML](/guides/echo-guides/echo-mjml), and more. Content can also be customized and hydrated using any datasource.
