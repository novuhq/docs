...
description: "Change notification content and behavior with confidence using Novu Dashboard UI."
---
...
Controls are modified directly on the [Novu Dashboard UI](https://dashboard.novu.co). Each Workflow editor page have an 'Controls' tab where you can modify them.
