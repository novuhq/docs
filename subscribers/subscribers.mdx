...
<Note>
It is possible for two subscribers to have the same email address in our system. This is because the subscriber ID is the unique identifier that distinguishes one subscriber from another.
 </Note>
