...
description: 'Retry API requests fearlessly, ensuring operation performance just once!'
icon: 'repeat-1'
---
...
- https://aws.amazon.com/builders-library/making-retries-safe-with-idempotent-APIs/eo
