...
- A Novu account. If you don't have one, sign up for free [here](https://web.novu.co/workflows?utm_campaign=docs-quick-nextjs).
...
After installing it, we need to connect our app with our Novu account using the Novu API key. Simply log onto the [Novu web dashboard](https://web.novu.co?utm_campaign=docs-quick-nextjs/) and from the settings there, obtain your API key. We’ll use it to connect our app to our Novu account.
...
You can see all this in our [integrations store](https://web.novu.co/integrations?utm_campaign=docs-quick-nextjs) and set it up there.
...
<Note>
You can only add those subscribers to a topic that you've already created. You can see all the subscribers in the [Novu web dashboard](https://web.novu.co/subscribers)?utm_campaign=docs-quick-nextjs
</Note>
