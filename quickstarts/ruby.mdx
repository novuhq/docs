...
<Frame caption="Make sure your notification workflow's trigger ID/slug matches the value you'd used"><img src="/images/template-nodejs.png" /> </Frame>
...
The value of the `name` key in the payload should be the name of the notification created earlier ([Trigger A Notification](https://docs.novu.co/overview/introduction/#trigger-a-notification) section)
