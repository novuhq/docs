---
title: 'General'
description: 'Learn how to use Novu to quickly send multi-channel (SMS, Email, Chat, Push) notifications.'
---
...
- Create a workflow
- Send a trigger
- Integrate the [Notification Center](https://docs.novu.co/notification-center/getting-started) within your app *(optional)*
