...
For local development we use [LocalStack.cloud](https://localstack.cloud/) is utilized as a local emulation of S3 during development.
...
- private write access (get, put, delete) [<-- not sure you actually need list actions in policy]
