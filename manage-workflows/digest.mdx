...
<CardGroup cols={2}>
  <Card title="Add Digest to Email Notifications" icon="envelope" color="#ea5a0c" href="https://novu.mintlify.app/guides/add-digest-to-email-notifications">
    Learn how to add digest functionality to email notifications.
  </Card>
  <Card title="Add Digest to In-App Notifications" icon="bell" color="#0285c7" href="https://novu.mintlify.app/guides/add-digest-to-inapp-notifications">
