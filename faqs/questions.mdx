...
No worries, we got your back. Many questions can be answered on our [documentation site](https://docs.novu.co/). If for some reason something is missing, go ahead and use our [Discord](https://discord.gg/novu?ref=docs-faqs), we usually answer right away, and with the help of the community members and moderators, it’s very effective.
