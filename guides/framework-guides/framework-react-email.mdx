...
<Frame caption="Echo Dev Studio now picks up the workflow we just created"><img src="/images/framework-react-email/7.png" /> </Frame>
...
<Frame caption="ngrok has done its magic"><img src="/images/framework-react-email/8.png" /> </Frame>
...
<Frame caption="Enter the Bridge URL in the Dev Studio"><img src="/images/framework-react-email/9.png" /> </Frame>
And create diff:
<Frame caption="Echo Dev Studio will create a diff for you"><img src="/images/framework-react-email/10.png" /> </Frame>
...
<Frame caption="Test your workflow will take you to Novu Cloud"><img src="/images/framework-react-email/11.png" /> </Frame>
...
<Frame caption="You'll see the workflow created using Novu Framework with the blue lightning bolt icon"><img src="/images/framework-react-email/12.png" /> </Frame>
...
<Frame caption="Enter the respective data and test your workflow"><img src="/images/framework-react-email/13.png" /> </Frame>
This is the workflow test email in my inbox:
<Frame caption="Workflow test email in my inbox"><img src="/images/framework-react-email/14.png" /> </Frame>
...
<Frame caption="AWS verification example"><img src="/images/framework-react-email/15.png" /> </Frame>
2. Apple invoice email example
<Frame caption="Apple invoice email example"><img src="/images/framework-react-email/16.png" /> </Frame>

## Conclusion
So there you go!

This is how you create workflows using Novu Framework and deploy your changes seamlessly to the Novu cloud. You can check out the code for a [sample demo app](https://github.com/novuhq/novu-echo-react-email). 
