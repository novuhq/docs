...
That’s how you create and use an OTP workflow. You can check out [our docs](https://docs.novu.co/guides/echo-guides/echo-react-email) for a hands on guide with more in-depth instructions.
