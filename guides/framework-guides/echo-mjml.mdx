...
This guide will walk you through how to send notifications with MJML and Novu. You can check out the code for a [sample demo app](https://github.com/novuhq/echo-mjml).
...
<Frame caption="Echo Dev Studio now picks up the workflow we just created"><img src="/images/echo-mjml/1.png" /> </Frame>
...
<Frame caption="ngrok has done its magic"><img src="/images/echo-mjml/2.png" /> </Frame>
...
<Frame caption="Enter the Echo URL in the Dev Studio"><img src="/images/echo-mjml/3.png" /> </Frame>
And create diff:
<Frame caption="Echo Dev Studio will create a diff for you"><img src="/images/echo-mjml/4.png" /> </Frame>
...
<Frame caption="Test your workflow will take you to Novu Cloud"><img src="/images/echo-mjml/5.png" /> </Frame>
...
<Frame caption="You'll see the workflow created using Echo with the blue lightning bolt icon"><img src="/images/echo-mjml/6.png" /> </Frame>
...
<Frame caption="Enter the respective data and test your workflow"><img src="/images/echo-mjml/7.png" /> </Frame>
This is the workflow test email in my inbox:
<Frame caption="Workflow test email in my inbox"><img src="/images/echo-mjml/8.png" /> </Frame>
...
This is how you create workflows using Echo and deploy your changes seamlessly to the Novu cloud. You can check out the code for a [sample demo app](https://github.com/novuhq/echo-mjml).
