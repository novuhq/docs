...
<Note>The entire code for this app is available on our Github.</Note>

So let's begin!

# Set up Discord
Setting up Discord is fairly straightforward. You just need the webhookUrl. It is pretty simple and can be done in the following easy steps:
