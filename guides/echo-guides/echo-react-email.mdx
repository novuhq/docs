...
This is how you create workflows using Echo and deploy your changes seamlessly to the Novu cloud. You can check out the code for a [sample demo app](https://github.com/novuhq/novu-echo-react-email). 
Once you've built the workflow, you might want read one of [our other guides](/guides/echo-guides/product) on how to empower product teams to manage notification workflows.
<br/>
