...
US and EU accounts are completely independent. If you have created an account in US, you will not be able to login with the same credentials in EU and vice versa.
