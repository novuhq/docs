...
Styling of your Inbox can be customized using the [styles](/inbox/styling#customization-hierarchy) prop. If you want to customize only a single component, you can use [available](/inbox/styling#appearance-prop) props.

### Additional Security for In-App Notifications

To add an extra layer of security, we recommend using our HMAC encryption feature to eliminate subscriber impersonation Checkout [HMAC](/inbox/production#hmac-encryption) section for more details.
