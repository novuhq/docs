...
If the Subscriber's locale field does not match with Translation locale files, or it is not available, then the defaul language of translation group will be used. If a default is not set, the automatic fallback is English. 
