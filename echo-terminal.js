...
var kt = (o, e, n) =>
  e in o
    ? $t(o, e, { enumerable: !0, configurable: !0, writable: !0, value: n })
    : (o[e] = n);
...
function Mt(o) {
  if (o.fragment !== null) {
    ...
    (o.dirty = [-1]),
      ...
      o.after_update.forEach(callback);
  }
}
function Tt(o) {
  const e = [],
...
function handleOutroTransition(component, duration, shouldDestroy, onComplete) {
  if (component && component.o) {
    ...
    outroTransitionSet.add(component),
      X.c.push(() => {
        outroTransitionSet.delete(component),
          onComplete && (shouldDestroy && component.d(1), onComplete());
      }),
...
function M(component, target, anchor) {
  ...
  fragment && fragment.m(target, anchor),
    callback(() => {
      ...
      component.$$.on_destroy ? component.$$.on_destroy.push(...l) : fe(l),
        (component.$$.on_mount = []);
    }),
...
function cleanupComponents(o, detachNode) {
  ...
  componentState.fragment !== null &&
    (Tt(componentState.after_update),
    fe(componentState.on_destroy),
    componentState.fragment && componentState.fragment.d(detachNode),
    (componentState.on_destroy = componentState.fragment = null),
    (componentState.ctx = []));
}
function markComponentAsDirty(component, dirtyIndex) {
  component.$$.dirty[0] === -1 &&
    (dirtyComponents.push(component), At(), component.$$.dirty.fill(0)),
    (component.$$.dirty[(dirtyIndex / 31) | 0] |= 1 << dirtyIndex % 31);
}
function renderComponent(
  ...
  if (
    ((f.ctx = createFragment
      ? createFragment(component, options.props || {}, (c, u, ..._) => {
          ...
          return (
            f.ctx &&
              i(f.ctx[c], (f.ctx[c] = g)) &&
              (!f.skip_bound && f.bound[c] && f.bound[c](g),
              a && markComponentAsDirty(component, c)),
            u
          );
        })
      : []),
    ...
    options.intro && h(component.$$.fragment),
      M(component, options.target, options.anchor),
      ut();
  }
  se(r);
}
...
const Pt = "4";
typeof window < "u" &&
  (window.__svelte || (window.__svelte = { v: new Set() })).v.add(Pt);
const ee = [];
function Ot(o, e = O) {
  let n;
  const t = new Set();
  ...
  return {
    c() {
      (e = x("div")),
        (n = x("div")),
        f && f.c(),
        $(n, "class", "nv-snippet-window"),
        z(n, "is-pop", o[0]),
        $(e, "class", "nv-snippet-window-wrapper terminal-cqc4oo"),
...
class G extends Component {
  constructor(e) {
    super(),
      renderComponent(this, e, createComponentState, Ht, B, {
        pop: 0,
        line: 1,
        pos: 2,
        noninteractable: 3,
...
function addText(line, text, time = 65) {
  ...
  for (const s of text.split(/(<\/?[^>]+>)/g)) {
    ...
    for (const p of s.split(""))
      (i += 1),
        t.push({ type: "write", line: line, time: calcTime(time), text: p });
  }
  return t;
}
...
function processAnimationStep(
  ...
  return currentStep
    ? (currentStep.type === "add-line" &&
        (textLines.splice(currentStep.line, 0, ""),
        (textLines[currentStep.line] = " ".repeat(currentStep.spaces)),
        (animation.cursor = {
          line: currentStep.line,
          pos: removeHtmlTags(textLines[currentStep.line]).length,
        })),
      currentStep.type === "write" &&
        ((textLines[currentStep.line] += currentStep.text),
        (animation.cursor = {
          line: currentStep.line,
          pos: removeHtmlTags(textLines[currentStep.line]).length,
        }),
        animation.completionWindow &&
          ((animation.completionWindow.pos = removeHtmlTags(
            textLines[currentStep.line]
          ).length),
          (animation.completionWindow.written += 1))),
      currentStep.type === "rewrite" &&
        ((textLines[currentStep.line] =
          textLines[currentStep.line].slice(0, -currentStep.delete) +
          currentStep.text),
        (animation.cursor = {
          line: currentStep.line,
          pos: removeHtmlTags(textLines[currentStep.line]).length,
      ...
      currentStep.type === "start-completion" &&
        (animation.completionWindow = {
          completion: currentStep.completion,
          completions: currentStep.completions,
          line: currentStep.line,
          pos:
            removeHtmlTags(textLines[currentStep.line]).length -
            (currentStep.n ?? 0),
          written: currentStep.n ?? 0,
          index: 0,
        }),
      currentStep.type === "change-completion" &&
        (animation.completionWindow.index = currentStep.index),
      currentStep.type === "end-completion" &&
        ((animation.completionWindow = void 0),
        (textLines[currentStep.line] += currentStep.text),
        (animation.cursor = {
          line: currentStep.line,
          pos: removeHtmlTags(textLines[currentStep.line]).length,
  ...
  return {
    c() {
      ...
      (n = W()),
        f && f.c(),
        (i = D()),
        $(e, "class", "nv-completion-items terminal-10kv6jm"),
    ...
    p(c, u) {
      ...
      if (u & 51) {
        ...
        for (g = 0; g < s.length; g += 1) {
          ...
          p[g]
            ? (p[g].p(m, u), h(p[g], 1))
            : ((p[g] = Te(m)), p[g].c(), h(p[g], 1), p[g].m(e, null));
        }
...
class mt extends Component {
  constructor(e) {
    super(),
      renderComponent(this, e, Zt, jt, B, {
        selectable: 1,
        noninteractable: 2,
        pop: 3,
        completions: 4,
...
function CompletionPopover(o) {
  ...
  return {
    ...
    p(d, v) {
      if (v & 16) {
        ...
        for (C = 0; C < f.length; C += 1) {
          ...
          a[C]
            ? (a[C].p(le, v), h(a[C], 1))
            : ((a[C] = Ee(le)), a[C].c(), h(a[C], 1), a[C].m(e.parentNode, e));
        }
    ...
    o(d) {
      ...
      handleOutroTransition(u),
        handleOutroTransition(_),
        handleOutroTransition(g),
        handleOutroTransition(m),
        handleOutroTransition(L),
        handleOutroTransition(y),
        (r = !1);
    },
    d(d) {
      d && (k(e), k(n), k(t), k(i), k(l), k(s), k(p)),
        K(a, d),
        u && u.d(d),
        _ && _.d(d),
        g && g.d(d),
    ...
    p(a, c) {
      if (c & 32) {
        ...
        for (u = 0; u < l.length; u += 1) {
          ...
          s[u]
            ? (s[u].p(_, c), h(s[u], 1))
            : ((s[u] = Re(_)), s[u].c(), h(s[u], 1), s[u].m(e.parentNode, e));
        }
      ...
      a[3].completionWindow
        ...
        a[3].cursor
          ? f
            ? f.p(a, c)
            : ((f = TerminalCursor(a)), f.c(), f.m(t.parentNode, t))
          : f && (f.d(1), (f = null));
    },
    i(a) {
      if (!i) {
...
function Ee(o) {
  ...
  return (
    (e = new ie({
      props: { index: o[27], $$slots: { default: [Ft] }, $$scope: { ctx: o } },
    })),
    {
      c() {
        P(e.$$.fragment);
  ...
  return (
    (e = new G({
      props: {
        ...
        pop: !0,
        noninteractable: !0,
        $$slots: { default: [SeenCompletionPopoverContent] },
        $$scope: { ctx: o },
      },
    })),
    {
...
function SeenCompletionPopoverContent(o) {
  let e,
    seenCompletionPopoverContent =
      "<comment>(property) seen: boolean</comment><hr/>Flag indicating if the notification has been seen.";
  return {
    c() {
...
function Re(o) {
  ...
  return (
    (e = new ie({
      props: { index: o[27], $$slots: { default: [Xt] }, $$scope: { ctx: o } },
    })),
    {
      c() {
        P(e.$$.fragment);
...
function qe(o) {
  ...
  return (
    (e = new mt({
      props: { completions: o[8], completionWindow: o[3].completionWindow },
    })),
    {
      c() {
        P(e.$$.fragment);
...
function TerminalCursor(o) {
  ...
  return {
    ...
    p(i, l) {
      l & 8 &&
        n !== (n = `calc(${i[3].cursor.line}em * 1.35 + 52px)`) &&
        Z(e, "top", n),
        l & 72 &&
          t !== (t = `calc(${i[3].cursor.pos + 3}ch + 14px - ${i[6]}px)`) &&
          Z(e, "left", t);
    },
    d(i) {
      i && k(e);
...
<hr/>The event that triggered the workflow.`,
    triggerCompletionPopoverContent = (
      chosenModel
    ) => `<comment>(method) trigger: Trigger</comment>
<hr/>Trigger a notification workflow.`,
  ...
  const stepCompletionDescription = (
    stepId,
    stepType,
    textDescription = ""
  ) => {
...
<hr/>${textDescription}`;
  ...
  let finalStateSnippet =
    `<kw>import</kw> { Echo } <kw>from</kw> <str>'@novu/echo'</str>;
...
`);
  const eventCompletions = [
    {
      text: "environment",
      description: `<comment>(property) environment: { id: 'development' | 'production', ... }</comment>
<hr/>The environment the workflow is running in.`,
    },
    { text: "inputs" },
    {
      text: "payload",
      description: `<comment>(property) payload: { postId: string }</comment>
<hr/>The payload for the event, provided during trigger.`,
    },
    {
      text: "step",
      description: `<comment>(method) step: { chat: ChannelStep<Echo.Chat>, delay: ActionStep<Echo.Digest>, ... }</comment>
<hr/>Define a step in your workflow.`,
    },
    {
      text: "subscriber",
      description: `<comment>(property) subscriber: { firstName: string, lastName: string, subscriberId: string }</comment>
<hr/>The subscriber receiving the notification.`,
  ...
  const stepCompletions = [
    {
      type: "method",
      text: "chat",
      description: stepCompletionDescription(
        "chat",
        "channel",
        "Send a chat message."
      ),
    ...
    },
    {
      type: "method",
      text: "sms",
      description: stepCompletionDescription("sms", "channel", "Send an SMS."),
    },
  ];
  ...
  const payloadCompletions = [
    {
      text: "postId",
      description: `<comment>(property) postId: string</comment>`,
    },
  ];
  ...
  const inAppInputCompletions = [
    {
      text: "body",
      description: `<comment>(property) body: string</comment>
...
<hr/>The body of the email.`,
    ...
    {
      text: "subject",
      description: `(property) subject: string
...
<hr/>The event payload for the workflow.`,
    ...
    {
      text: "to",
      description: `<comment>(property) to: { subscriberId: string, firstName: string, lastName: string }</comment>
<hr/>The subscriber to notify.`,
  ...
  const channelResultCompletions = [
    {
      text: "seen",
      description: `<comment>(property) seen: boolean</comment>
<hr/>Flag indicating if the notification has been seen.`,
    },
    {
      text: "read",
      description: `<comment>(property) read: boolean</comment>
<hr/>Flag indicating if the notification has been read.`,
  ...
  const subscriberCompletions = [
    {
      text: "firstName",
      description: `<comment>(property) firstName: string</comment>
<hr/>The subscriber's first name.`,
    },
    {
      text: "lastName",
      description: `<comment>(property) lastName: string</comment>
<hr/>The subscriber's last name.`,
    },
    {
      text: "subscriberId",
      description: `<comment>(property) subscriberId: string</comment>
  ...
  const stepOptionsCompletions = [
    {
      type: "method",
      text: "skip",
      description: `<comment>(method) skip: () => boolean</comment>
<hr/>Skip the step if the condition is met.`,
  ...
  const transitions = [
    ...
    addText(
      11,
      `</fn>(<str>'weekly-comments'</str>, <kw>async</kw> (inputs) => {`
    ),
    addLine(12, 4),
    ...
    openCompletions(13, {
      ...
      completions: [
        {
          text: "length",
          description: `<comment>(property) Array<T>.length: number</comment>
<hr/>Gets or sets the length of the array. This is a number one higher than the highest index in the array.`,
    ...
    addText(24, `});`),
    {
      ...
      callback: () => {
        ...
        transitionToState(0, (i = !1)),
          transitionToState(2, (m = "echo-client")),
          setTimer();
      },
    },
  ].flat();
...
`),
  ...
  function setTimer(taskDelay = 3e3) {
    clearTimeout(taskTimeout),
      (taskTimeout = setTimeout(executeStateTransition, taskDelay));
  }
  function executeStateTransition() {
    currentState === "echo-client"
      ...
      : currentState === "echo-trigger" &&
        transitionToState(2, (currentState = "echo-client")),
      setTimer();
  }
  function handleStateTransition(event) {
    const targetElement =
      event.target.parentElement.tagName === "SPAN"
        ...
        : event.target;
    if (targetElement.id === "nv-node-echo-client")
      transitionToState(2, (currentState = "echo-client"));
    else if (targetElement.id === "nv-node-echo-event")
      transitionToState(2, (currentState = "echo-event"));
    else if (targetElement.id === "nv-node-echo-payload")
      transitionToState(2, (currentState = "echo-payload"));
    else if (targetElement.id === "nv-node-echo-step")
      transitionToState(2, (currentState = "echo-step"));
    else if (targetElement.id === "nv-node-echo-trigger")
      transitionToState(2, (currentState = "echo-trigger"));
    else if (targetElement.id === "nv-node-echo-seen")
      transitionToState(2, (currentState = "echo-seen"));
    else {
  ...
  function executeStateTransitionWithAnimation(A) {
    transitionToState(
      3,
      ({ animation: animation, lines: initialText } = processAnimationStep(
        transitions,
        A,
        animation,
        initialText
      ...
      animation,
      transitionToState(5, initialText)
    );
    ...
    nextTransition &&
      transitionToState(
        ...
        (animation.timeout = setTimeout(
          () => executeStateTransitionWithAnimation(A + 1),
          nextTransition.time
        )),
        animation
      );
  ...
  function ht() {
    transitionToState(3, (animation = { timeout: void 0 })),
      executeStateTransitionWithAnimation(0);
  }
  ...
  const _t = () => setTimer(1500),
    gt = (A) => {
      transitionToState(
        7,
        (StepCompletionComponent.completion = A.detail),
        StepCompletionComponent
      ),
        transitionToState(
          4,
          (finalStateSnippet[6] = `    model: <span class="hover" id="nv-node-echo-step"><str>'${A.detail}'</str></span>,`),
          finalStateSnippet
        );
    };
  function wt(A) {
  ...
  return (
    ...
    (o.$$.update = () => {
      ...
      o.$$.dirty & 8 &&
        transitionToState(
          8,
          (t =
            (A = animation.completionWindow) == null
              ? void 0
              : A.completions.filter(({ text: V }) =>
                  V.startsWith(
                    animation.completionWindow.completion.slice(
                      0,
                      animation.completionWindow.written
                    )
                  )
                ))
        );
    ...
    [
      ...
      StepCompletionComponent,
      t,
      echoCompletionPopoverContent,
      stepCompletionPopoverContent,
...
class NodeSnippet extends Component {
  constructor(e) {
    super(),
      renderComponent(this, e, initializeEchoNode, Yt, B, { animated: 0 });
  }
}
function Ze(o, e, n) {
  const t = o.slice();
...
function ze(o) {
  ...
  return (
    (e = new ie({
      props: { index: o[8], $$slots: { default: [nn] }, $$scope: { ctx: o } },
    })),
    {
      c() {
        P(e.$$.fragment);
  ...
  return {
    c() {
      (e = x("div")),
        ...
        (n = W()),
        (t = x("div")),
        $(e, "class", "nv-completion-heading"),
        $(t, "class", "nv-completion-item");
      ...
      p(r, [f]) {
        if (f & 2) {
          ...
          for (c = 0; c < l.length; c += 1) {
            ...
            s[c]
              ? (s[c].p(u, f), h(s[c], 1))
              : ((s[c] = ze(u)), s[c].c(), h(s[c], 1), s[c].m(e, n));
          }
...
function Ue(o) {
  ...
  return (
    (e = new ie({
      props: { index: o[11], $$slots: { default: [cn] }, $$scope: { ctx: o } },
    })),
    {
      c() {
        P(e.$$.fragment);
    ...
    p(s, p) {
      if (p & 1) {
        ...
        for (r = 0; r < i.length; r += 1) {
          ...
          l[r]
            ? l[r].p(f, p)
            : ((l[r] = Je(f)), l[r].c(), l[r].m(t.parentNode, t));
        }
      ...
      p(r, [f]) {
        if (f & 2) {
          ...
          for (c = 0; c < l.length; c += 1) {
            ...
            s[c]
              ? (s[c].p(u, f), h(s[c], 1))
              : ((s[c] = Ue(u)), s[c].c(), h(s[c], 1), s[c].m(e, n));
          }
          for (H(), c = l.length; c < s.length; c += 1) p(c);
          S();
        }
    ...
    function a() {
      ...
      function u() {
        f === l.length
          ? (p = setTimeout(r, 5e3))
          : c === 3
          ? (s.push({ text: "<comment>Loading next page</comment>" }),
            n(0, s),
            (p = setTimeout(a, 1e3)),
            f--)
          : f < l.length && (s.push(l[f]), n(0, s), (p = setTimeout(u, 250))),
          c++,
          f++;
      }
      u();
...
function Qe(o) {
  ...
  return (
    (e = new ie({
      props: { index: o[4], $$slots: { default: [mn] }, $$scope: { ctx: o } },
    })),
    {
      c() {
        P(e.$$.fragment);
    ...
    p(s, [p]) {
      if (p & 1) {
        ...
        for (r = 0; r < t.length; r += 1) {
          ...
          i[r]
            ? (i[r].p(f, p), h(i[r], 1))
            : ((i[r] = Qe(f)), i[r].c(), h(i[r], 1), i[r].m(e, null));
        }
...
function Ye(o) {
  ...
  return (
    (e = new ie({
      props: { index: o[4], $$slots: { default: [gn] }, $$scope: { ctx: o } },
    })),
    {
      c() {
        P(e.$$.fragment);
    ...
    p(s, [p]) {
      if (p & 1) {
        ...
        for (r = 0; r < t.length; r += 1) {
          ...
          i[r]
            ? (i[r].p(f, p), h(i[r], 1))
            : ((i[r] = Ye(f)), i[r].c(), h(i[r], 1), i[r].m(e, null));
        }
        for (H(), r = t.length; r < i.length; r += 1) l(r);
        S();
      }
...
function tt(o) {
  ...
  return {
    c() {
      (e = x("button")),
        (e.textContent = `${o[6].name}`),
        $(e, "class", "nv-terminal-tab terminal-1dfudv"),
    ...
    c && (l = me(c, u(o))),
    {
      c() {
        ...
        (t = W()),
          (i = x("div")),
          l && P(l.$$.fragment),
          $(n, "class", "nv-terminal-tabs terminal-1dfudv"),
          $(i, "class", "nv-code-content terminal-1dfudv"),
          $(e, "id", "nv-terminal"),
          $(e, "class", "nv-code terminal-1dfudv");
      },
      m(_, g) {
        b(_, e, g), E(e, n);
...
function TerminalComponent(o, e, n) {
  const t = {
    node: { name: "Node", component: NodeSnippet },
    python: { name: "Python", component: PythonSnippet },
    go: { name: "Go", component: GoSnippet },
    java: { name: "Java", component: JavaSnippet },
    kotlin: { name: "Kotlin", component: KotlinSnippet },
  };
  let i = t.node,
    l = !0;
  return [
...
const echoTerminalCss = css`
  ...
  #nv-terminal {
    ...
    height: 600px;
    max-width: 700px;
    box-shadow: 0 4px 8px -2px #0f111a29, 0 10px 15px -4px #0f111a29,
      0 30px 32px -15px #0f111a29, 0 60px 64px -25px #0f111a29;
  }
