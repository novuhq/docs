...
- **Preference Management**: With tags, users can manage their notification preferences by category, choosing to enable or mute specific types of notifications.

Think of it as organizing emails into folders—tags help keep things tidy and manageable for both you and your users.


## How to Add Tags to Notifications (Coming Soon To The UI)
<Note>
You can [add tags to notifications using the framework](/docs/framework/tags). We're working on adding this feature to the UI.
</Note>
