...
<Warning> The **Custom** action step is currently available only when using the [**Novu Framework**](http://localhost:3000/framework/quickstart/overview) for code-based Workflows. </Warning>
