...
sidebarTitle: "Workflow Editor"
---

The **Workflow Editor** empowers seamless collaboration between technical and non-technical teams. 
It simplifies building automated, personalized workflows without coding while also allowing developers to refine code-based workflows. 

This shared tool bridges the gap between teams, accelerating the delivery of tailored notifications and ensuring a smoother workflow creation process.
