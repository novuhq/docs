...
- A Novu account. [Sign up for free](http://web.novu.co/?utm_campaign=docs-gs-quick-vanilla) if you don’t have one yet.
...
An application identifier is a public key used to identify your application. You can get your own application identifier from the [Novu dashboard settings](https://web.novu.co/settings?utm_campaign=docs-quick-vanilla).

And subscribers are users to which notifications will be sent. They are identified by a `subscriberID` which you can also find in the [Novu subscribers dashboard](https://web.novu.co/subscribers?utm_campaign=docs-quick-vanilla). Let's learn more about subscribers.

## Subscribers in Novu

If you click “Subscriber” on the left sidebar of the [Novu dashboard](https://web.novu.co/subscribers?utm_campaign=docs-quick-vanilla), you’ll see the subscriber list. By default, there will only be one subscriber as you’re automatically added as a subscriber when you sign up for Novu:
