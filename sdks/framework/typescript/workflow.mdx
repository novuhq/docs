...
<ParamField path="handler" type="(context: WorkflowContext) => Promise<void>" required>
...
<ParamField path="step" type="object">
    The object that contains all the step functions, read more at [Step Functions](/sdks/framework/typescript/steps/introduction).
</ParamField>
