...
<CardGroup cols={2}>
  ...
  <Card title="IFrame Embed" icon="html5" color="#dc2626" href="/sdks/iframe-embed">
...
<CardGroup cols={2}>
  ...
  <Card title=".NET" icon="microsoft" color="#dc2626" href="/sdks/dotnet">
