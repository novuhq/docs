/**
 * Remix logo mark. Path from Simple Icons (CC0):
 * https://github.com/simple-icons/simple-icons/blob/develop/icons/remix.svg
 */
export function RemixIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden {...props}>
      <path
        fill="#000000"
