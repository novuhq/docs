...
export async function GithubInfo({
  ...
  return (
    <a
      ...
      {...props}
      className={cn(
        'flex flex-col gap-1.5 p-2 rounded-lg text-sm text-black dark:text-white dark:opacity-80 transition-opacity lg:flex-row lg:items-center hover:opacity-100 opacity-60',
        props.className
      )}
    >
      <p className="flex items-center gap-2 truncate">
        <svg fill="currentColor" viewBox="0 0 24 24" className="size-3.5 text-black dark:text-white">
          <title>GitHub</title>
      ...
      <p className="flex text-xs items-center gap-1 text-black dark:text-white">
