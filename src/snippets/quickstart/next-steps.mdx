...
- Explore different [Channel Steps](/framework/typescript/steps/overview) like Email, SMS, Push, and more
- Set up [Action Steps](/framework/typescript/steps/overview) like Delay and Digest
