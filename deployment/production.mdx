...
Novu Cloud workers will need to be able to communicated with your [Bridge Endpoint](/concepts/endpoint). You will need to ensure that your firewall rules allow traffic from the internet.
