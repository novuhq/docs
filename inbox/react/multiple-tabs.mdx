...
The notifications are filtered and matched by comparing the [workflow](/workflow/introduction) `tags` field with the tab `value` field. Each notification is a part of a specific [workflow](/concepts/workflows). You can combine tags from different workflows to create a customized tab experience.
