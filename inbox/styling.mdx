...
<Tip>You can see Styling in action on the [Inbox Playground](https://inbox.novu.co) with common themes like Notion, Reddit and more!.</Tip>
...
<ResponseField name="Available Variables" type="variables" >
  <Expandable title="properties">
    ...
    <ParamField body="colorShadow" type="string">
