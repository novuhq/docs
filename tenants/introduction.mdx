...
Tenants can be created and modified via the [API](https://api.novu.co/api#/Tenants) or [Web](https://web.novu.co/tenants). Each tenant can have multiple fields on it:
