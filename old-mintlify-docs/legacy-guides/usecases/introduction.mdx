...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="circle-2"
    color="#0285c7"
    href="/legacy-guides/usecases/embedded-notification-center"
  ></Card>
  <Card
    title="Digest multiple events in a single notification"
    icon="circle-3"
    color="#16a34a"
    href="/legacy-guides/usecases/digest-multiple-events"
  ></Card>
  <Card
    title="Manage notification in multiple languages"
    icon="circle-4"
    color="#dc2626"
    href="/legacy-guides/usecases/manage-notifications-in-multiple-languages"
  ></Card>
  <Card
    title="Processing and sending notifications at any scale"
    icon="circle-5"
    color="#dc2626"
    href="/legacy-guides/usecases/send-notifications-at-any-scale"
  ></Card>
  <Card
    title="Centralized multiple legacy implementations of different teams"
    icon="circle-6"
    color="#dc2626"
    href="/legacy-guides/usecases/centralized-multiple-legacy-implementations"
  ></Card>
  <Card
    title="Debug notifications across channels and vendors in a singe place"
    icon="circle-7"
    color="#dc2626"
    href="/legacy-guides/usecases/debug-notifications"
  ></Card>
</CardGroup>
