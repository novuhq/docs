...
- RateLimit-Remaining
  ...
  Indicates the remaining number of request tokens in current window.
...
- RateLimit-Reset
  ...
  Indicates the seconds until current window resets and the request token limit is fully replenished.
...
- Retry-After
  ...
  Specify how long to wait before making another request.