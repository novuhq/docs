...
- RateLimit-Remaining
  Indicates how many requests you have left in the current window.

- RateLimit-Limit
  Shows the total number of requests allowed.

- RateLimit-Reset
  Indicates shows when the current window will reset.
