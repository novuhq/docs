...
fun main() {
    ...
    val createEnvironmentRequest = CreateEnvironmentRequest("Stagging", "parentEnvironmentId")
    val createEnvironment = novu.createEnvironment(createEnvironmentRequest)
    println(createEnvironment)
}
```
