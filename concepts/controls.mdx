...
<Info>
  **Examples** - Color of a button, text of a button, should a section be shown,
  digest duration, static text content, the order of the email sections, and
  etc...
</Info>
...
Step control schema is defining the control passed during the `step` method. Those controls can be modified and persisted in the Novu Dashboard UI.
