...
When you define a `controlSchema` for a step, Novu Studio will automatically generate a UI for the controls in the workflow editor.

- **Form Input Title** - Will be derived from the key of the Zod schema. Unfortuently Zod does not support custom titles at this point.
