...
<Frame caption="See your API key on your homepage">
  <img src="/images/channels-and-providers/sms/infobip/image-63.png" />{" "}
</Frame>
...
<Frame caption="Find your API key from the developer tools">
  <img src="/images/channels-and-providers/sms/infobip/image-64.png" />{" "}
</Frame>
...
- Click on `GENERATE`
  <Frame caption="Generate your API key">
    <img src="/images/channels-and-providers/sms/infobip/image-65.png" />{" "}
  </Frame>
...
<Frame caption="Your base URL is on the homepage">
  <img src="/images/channels-and-providers/sms/infobip/image-66.png" />{" "}
</Frame>
