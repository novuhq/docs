...
<Frame caption="Email Editor">
  <img src="/images/channels-and-providers/email/writing-email-template/email-editor.png" />
</Frame>
...
<Frame caption="Email Editor Blocks">
  <img src="/images/channels-and-providers/email/writing-email-template/email-blocks.gif" />
</Frame>
...
- **For** - Can be used for interation on array of data
- **Show** - Can be used to conditionally show content based on a condition, use eye icon to toggle the visibility of the content

### For Block

For block is synonyms with the javascript language `for` loop. It can be used to iterate over an array of data and render a block for each item in the array. Use + icon or / to add a for block. Checkout the below video on how to use for block

<iframe
  width="100%"
  height="400"
  src="https://www.youtube.com/embed/TKToT3-e_xc"
...
- `{{payload.order.items.quantity}}` is the quantity of the item
...
<Frame caption="Show Block">
  <img src="/images/channels-and-providers/email/writing-email-template/show-block.gif" />
</Frame>
