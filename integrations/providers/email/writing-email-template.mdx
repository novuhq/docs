...
For block is synonyms with the javascript language `for` loop. It can be used to iterate over an array of data and render a block for each item in the array.
