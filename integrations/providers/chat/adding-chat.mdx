...
4. Create a new [worklow](/workflow/introduction) or use an existing workflow. Add chat channel and [write content](/content-creation-design/notification-content-creation#chat) for the message.
