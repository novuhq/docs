...
await novu.trigger({
  ...
  payload: {
    // If the notification is a data notification, 
    // the payload will be sent as the data
    abc: "def", 
  },
  overrides: {
    type: "data",
